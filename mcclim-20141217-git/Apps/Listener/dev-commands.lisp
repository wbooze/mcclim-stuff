  ...
  (multiple-value-bind (style ink)
      (values
       ...
       (cond ((eql (symbol-package symbol)
              ...
              (make-rgb-color 1.0 0.5 0.9))
             ((fboundp symbol)        (make-rgb-color 0.5  0.5  1.0))
             ((find-class symbol nil) (make-rgb-color 0.03 0.35 0.48))
             ((boundp symbol)         (make-rgb-color 0.77  0.77  0.77))
...
(defun show-file (pathname)
  (let ((stream
	  (open-window-stream :background +grey10+ :foreground +wheat4+)))
