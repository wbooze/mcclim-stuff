...
;;; Here are alternate mappings for the unicode family of fonts, which
;;; are with improved unicode coverage.
(defparameter *unifont-families/faces* 
  '(((:fix :roman) . "unifont.ttf") 
    ((:fix :italic) . "unifont.ttf")
    ((:fix (:bold :italic)) . "unifont.ttf")
    ((:fix (:italic :bold)) . "unifont.ttf") 
    ((:fix :bold) . "unifont.ttf")
    ((:serif :roman) . "unifont.ttf") 
    ((:serif :italic) . "unifont.ttf")
    ((:serif (:bold :italic)) . "unifont.ttf")
    ((:serif (:italic :bold)) . "unifont.ttf") 
    ((:serif :bold) . "unifont.ttf")
    ((:sans-serif :roman) . "unifont.ttf") 
    ((:sans-serif :italic) . "unifont.ttf")
    ((:sans-serif (:bold :italic)) . "unifont.ttf")
    ((:sans-serif (:italic :bold)) . "unifont.ttf")
    ((:sans-serif :bold) . "unifont.ttf")))

(defparameter *families/faces* *unifont-families/faces*)
